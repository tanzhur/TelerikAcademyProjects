...
{
	public partial class CatalogEntities : OpenAccessContext, ICatalogEntitiesUnitOfWork
	{
		...
		public CatalogEntities(string connection)
			:base(connection, backend, metadataSource)
		{ }
		
		public CatalogEntities(BackendConfiguration backendConfiguration)
		...
		public CatalogEntities(string connection, BackendConfiguration backendConfiguration, MetadataSource metadataSource)
	...
	public interface ICatalogEntitiesUnitOfWork : IUnitOfWork
	{
